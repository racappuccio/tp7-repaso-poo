        ...
        while (!opcionValida) {
            try {
                ...
                if (opcion != 1 && opcion != 2) {
                    throw new OpcionInvalidaException("Debe elegir 1 (Titular) o 2 (Suplente)");
                }
                opcionValida = true;
            ...
            } catch (LegajoInvalidoException | EdadInvalidaException | SalarioInvalidoException |
                     AntiguedadInvalidaException e) {
                System.err.println("Error al crear docente: " + e.getMessage());
            } catch (Exception e) {
                System.err.println("Error inesperado: " + e.getMessage());
       //     } catch (OpcionInvalidaException e){
       //         System.err.println(e.getMessage() + ". Intente nuevamente. \n");
       //     } catch (InputMismatchException e) {
       //         System.err.println("Debe ingresar un número. Intente nuevamente. \n");
            }
            int opcion = scanner.nextInt();
        }
    }
